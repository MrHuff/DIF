...
#COVID
###benchmark run
#python main_DIF.py --hdim=512 --prefix "covid256" --output_height=256 "--channels=32, 64, 128, 256, 512, 512" --m_plus=1000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/covid_dataset_256x256 --trainsize=1900 --test_iter=136 --save_iter=10 --start_epoch=0 --batchSize=24 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=300 --class_indicator_file=/homes/rhu/data/covid_19_sick.csv --fp_16 --J=0.25 --lambda_me=0 --C=10 --tanh_flag --cdim 1
###encoder run
#python main_DIF.py --hdim=512 --prefix "covid256" --output_height=256 "--channels=32, 64, 128, 256, 512, 512" --m_plus=1000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/covid_dataset_256x256 --trainsize=1900 --test_iter=136 --save_iter=10 --start_epoch=0 --batchSize=24 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=300 --class_indicator_file=/homes/rhu/data/covid_19_sick.csv --fp_16 --J=0.25 --lambda_me=0.5 --C=10 --tanh_flag --kernel "linear" --cdim 1
#linear_benchmark-encoder
##python main_DIF.py --hdim=512 --prefix "covid256" --output_height=256 "--channels=32, 64, 128, 256, 512, 512" --m_plus=1000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/covid_dataset_256x256 --trainsize=1900 --test_iter=136 --save_iter=10 --start_epoch=0 --batchSize=24 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=300 --class_indicator_file=/homes/rhu/data/covid_19_sick.csv --fp_16 --J=0.25 --lambda_me=1.0 --C=10 --tanh_flag --kernel "rbf" --linear_benchmark --cdim 1
