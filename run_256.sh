...
#encoder run
#python main_DIF.py --prefix "fashion" --hdim=512 --output_height=256 "--channels=32, 64, 128, 256, 512, 512" --m_plus=2000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/fashion_256x256 --trainsize=22000 --test_iter=1000 --save_iter=10 --start_epoch=0 --batchSize=24 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=300 --class_indicator_file=/homes/rhu/data/fashion_price_class.csv --fp_16 --J=0.25 --lambda_me=0.05 --C=10 --tanh_flag --kernel "linear"
###flow run
#python main_DIF_flow.py --prefix "fashion" --hdim=512 --output_height=256 "--channels=32, 64, 128, 256, 512, 512" --m_plus=2000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/fashion_256x256 --trainsize=22000 --test_iter=1000 --save_iter=10 --start_epoch=0 --batchSize=24 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=300 --class_indicator_file=/homes/rhu/data/fashion_price_class.csv --fp_16 --J=0.25 --lambda_me=0.1 --C=10 --tanh_flag --kernel "linear" --flow_depth 3
...
# encoder
#python main_DIF.py --prefix "mnist38" --hdim=16 --output_height=64 "--channels=64, 128, 256, 512" --m_plus=1000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/mnist_3_8_64x64 --trainsize=13000 --test_iter=500 --save_iter=2 --start_epoch=0 --batchSize=32 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=25 --class_indicator_file=/homes/rhu/data/mnist_3_8.csv --fp_16 --J=0.25 --lambda_me=0.05 --C=10 --tanh_flag --kernel "linear" --cdim 1
#flow
#python main_DIF.py --prefix "mnist38" --hdim=16 --output_height=64 "--channels=64, 128, 256, 512" --m_plus=1000 --weight_rec=1.0 --weight_kl=1.0 --weight_neg=0.5 --num_vae=10 --dataroot=/homes/rhu/data/mnist_3_8_64x64 --trainsize=13000 --test_iter=500 --save_iter=2 --start_epoch=0 --batchSize=32 --nrow=8 --lr_e=0.0002 --lr_g=0.0002 --cuda --nEpochs=25 --class_indicator_file=/homes/rhu/data/mnist_3_8.csv --fp_16 --J=0.25 --lambda_me=0.05 --C=10 --tanh_flag --kernel "linear" --flow_depth 3 --cdim 1
#linear benchmark encoder
